...
/**
 * @typedef {'PREVIOUS_PAPER' | 'MID_1' | 'MID_2' | 'MODEL_PAPER' | 'QUESTION_BANK' | 'SEMESTER_PAPER' | 'INTERNAL_PAPER' | 'SUBJECT_NOTES' | 'UNIT_NOTES' | 'FACULTY_NOTES' | 'STUDENT_NOTES' | 'LAB_MANUAL' | 'PPT' | 'ASSIGNMENT' | 'REFERENCE_MATERIAL'} ResourceType
 */
